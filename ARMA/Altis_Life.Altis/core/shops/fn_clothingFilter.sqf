...
_clothes = switch (life_clothing_store) do
{
	...
	case "medcloth": {[_selection] call life_fnc_clothing_med;};
	case "cl_ad" : {[_selection] call life_fnc_clothing_aac;};
	case "cl_sol" : {[_selection] call life_fnc_clothing_sol;};
	case "cl_wiss" : {[_selection] call life_fnc_clothing_wiss;};
};
