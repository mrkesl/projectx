...
lbClear _units;
_text ctrlSetStructuredText parseText format["<img size='1.7' image='icons\bank.paa'/> $%1<br/><img size='1.6' image='icons\money.paa'/> $%2",[(player getvariable["bankacc",0])] call life_fnc_numberText,[(player getvariable["cash",0])] call life_fnc_numberText];
