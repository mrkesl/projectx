...
private["_resourceZones","_zone","_weight","_item","_vInv","_itemIndex"];
...
[_vehicle] remoteExec ["life_fnc_soundDevice", 0, false]; //Broadcast the 'mining' sound of the device for nearby units.
