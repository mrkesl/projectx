/*
	...
	Reskins the vehicle
*/
params [["_vehicle", Objnull, [Objnull]], ["_index", -1, [0]]];
private["_texture2","_texture3"];
...
if(local _vehicle) then {
	...
	{
		case "C_Offroad_01_F": {[_vehicle,"color",3,true] remoteExec ["TON_fnc_setObjVar", 2, false];};
		case "C_Hatchback_01_F": {[_vehicle,"color",1,true] remoteExec ["TON_fnc_setObjVar", 2, false];};
		case "C_Hatchback_01_sport_F": {[_vehicle,"color",1,true] remoteExec ["TON_fnc_setObjVar", 2, false];};
		case "C_SUV_01_F": {[_vehicle,"color",1,true] remoteExec ["TON_fnc_setObjVar", 2, false];};
		case "C_Van_01_box_F": {[_vehicle,"color",1,true] remoteExec ["TON_fnc_setObjVar", 2, false];};
		case "C_Van_01_transport_F": {[_vehicle,"color",1,true] remoteExec ["TON_fnc_setObjVar", 2, false];};
	};
};
