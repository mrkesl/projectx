...
*/
private["_return","_uItems","_bItems","_vItems","_pItems","_hItems","_yItems","_uMags","_vMags","_bMags","_pMag","_hMag","_sMag","_uni","_ves","_bag","_handled"];
_return = [];
...

{
    ...
    ["life_inv_huetchen",life_inv_huetchen],
    ["life_inv_absperrung",life_inv_absperrung],
    ["life_inv_strahler",life_inv_strahler],
    ["life_inv_pole",life_inv_pole],
    ["life_inv_tapesign",life_inv_tapesign],
    ["life_inv_kabelbinder",life_inv_kabelbinder],
