...
_Btn8 buttonSetAction "[player] remoteExec [""life_fnc_breathalyzer"", life_pInact_curTarget, false];;closeDialog 0";

// Gear Button
_Btn9 ctrlSetText localize "STR_Open_Inv";
_Btn9 buttonSetAction "[life_pInact_curTarget] call life_fnc_opengearcop; closeDialog 0;";

//Check that you are near a place to jail them.
if(!((player distance (getMarkerPos "imprison") < 30) )) then
{
	_Btn7 ctrlEnable false; // von _Btn6 auf _Btn7 geändert!!!
};
