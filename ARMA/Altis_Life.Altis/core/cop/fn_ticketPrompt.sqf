...
[] spawn
{
	...
	{
		[0,"STR_Cop_Ticket_Refuse",true,[profileName]] remoteExec ["life_fnc_broadcast", west, false];
		[1,"STR_Cop_Ticket_Refuse",true,[profileName]] remoteExec ["life_fnc_broadcast", life_ticket_cop, false];
	};
};