...
*/
private["_dialog","_list","_plist","_sel","_vehicle","_owners","_index","_unit","_uid","_vehname"];
...
hint format["Du hast %1 deinen Schlüssel von %2 gegeben.",_unit getVariable["realname",name _unit],_vehname];
[_vehicle,_unit,profileName] remoteExec ["TON_fnc_clientGetKey", _unit, false];