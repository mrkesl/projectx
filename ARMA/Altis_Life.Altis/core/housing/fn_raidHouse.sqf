...
if(_value > 0) then {
	[0,"STR_House_Raid_Successful",true,[[_value] call life_fnc_numberText]] remoteExec ["life_fnc_broadcast", 0, false];
	...
	[_house] remoteExec ["TON_fnc_updateHouseTrunk", 2, false];
} else {
