...
*/
params [["_shortname", "", [""]], ["_amount", 0, [0]], ["_israw", false, [false]], ["_send", true, [true]]];
private["_price","_modifier","_globalprice","_min","_dir","_arr_resource","_arr_price","_modifier","_relamount","_max"];
diag_log format["market sell - _shortname = %1, _amount = %2, _israw = %3, _send = %4", _shortname, _amount, _israw, _send];
