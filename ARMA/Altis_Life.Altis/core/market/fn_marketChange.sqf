...
switch(true) do
{
	...
	{
		[0,"News: Interpol hat eine internationale Drogenbande ausgehoben!"] remoteExec ["life_fnc_broadcast", 0, false];
	...
	{
		[0,"News: Öltanker gesunken!"] remoteExec ["life_fnc_broadcast", 0, false];
	...
	{
		[0,"News: Der Wohnungsmarkt boomt! Altis braucht mehr Baustoffe!"] remoteExec ["life_fnc_broadcast", 0, false];
	...
	{
		[0,"News: Anleger verlieren Vertrauen in Gold!"] remoteExec ["life_fnc_broadcast", 0, false];
	...
	{
		[0,"News: Elektronikindustrie benötigt Edelmetalle!"] remoteExec ["life_fnc_broadcast", 0, false];
	...
	{
		[0,"News: Anleger verlieren Vertrauen in Dollar!"] remoteExec ["life_fnc_broadcast", 0, false];
	...
	{
		[0,"News: Neue synthetische Droge überschwemmt Drogenmarkt!"] remoteExec ["life_fnc_broadcast", 0, false];
	...
	{
		[0,"News: China entdeckt Schildkröten als neue Medizin! Tierschützer sind besorgt!"] remoteExec ["life_fnc_broadcast", 0, false];
