...
if (life_drink > 0.22) then {
			...
			[0,format[localize "STR_MISC_StPubIntox",profileName]] remoteExec ["life_fnc_broadcast", 0, false];
			[getPlayerUID player,profileName,"390"] remoteExec ["life_fnc_wantedAdd", 2, false];
