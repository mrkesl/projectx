...
if (sunOrMoon < 1) then {
	...
	_leftBack setLightAttenuation [0.1, 0, 0, 100000]; 
	_leftFront setLightAttenuation [0.1, 0, 0, 100000]; 
	_rightBack setLightAttenuation [0.1, 0, 0, 100000]; 
	_rightFront setLightAttenuation [0.1, 0, 0, 100000]; 
};
