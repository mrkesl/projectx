...
hint "Ein Helicopter macht sich auf den Weg zu dir, bitte hab einen Augendblick Geduld."
...
_containerdummy = createVehicle ["O_G_Quadbike_01_F", [3450.7363, 16708.432, 90], [], 0, "CAN_COLLIDE"];
_containerdummy attachTo [_cargoheli,[0,0,-3.5]];
_containerdummy setDir 90;

hint "Dein Quad wird nun abgeworfen.."

deleteVehicle _containerdummy;
sleep 0.1;
_container = createVehicle ["O_G_Quadbike_01_F", [3450.7363, 16708.432, 90], [], 0, "CAN_COLLIDE"];
