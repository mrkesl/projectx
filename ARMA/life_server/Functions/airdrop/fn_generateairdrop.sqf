...
["Airdrop.log", "Der manuelle Airdrop wurde ausgefuehrt."] remoteExec ["life_fnc_admin_log", 2, false];
sleep 300;
...
sleep 10;
[5,"<t size='1.2'><t color='#FF0000'>Wichtiger Hinweis! beendet!</t></t><br/><br/><t size='1'>Die Ladung der Hilfsgüter war instabil, sie ist mit einer starken Detonation explodiert!</t>"] remoteExec ["life_fnc_broadcast", 0, false];
